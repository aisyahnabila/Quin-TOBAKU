...
<body>
    ...
    <section class="mb-32">
        ...
        <div class="container mt-28 mx-auto px-4 my-8">
            ...
            <div class="mt-7">
                <p class="text-xl italic ">
                    Quin Tobaku menyediakan berbagai macam alat dan bahan kue dengan produk berkualitas tinggi dengan
                    harga terjangkau dan banyak variasi
                </p>
                <p class="text-xl mt-4 italic ">
                    Toko bahan kue “Quin Tobaku” berdiri pada tahun 2019 di Jalan Raya Tambakrejo no.33 Waru Sidoarjo.
                    Toko ini menjual bahan kue, roti, dan plastik. Bermula dari hobi baking yang kemudian ditekuni untuk
                    dilanjutkan sebagai usaha, pemilik toko “Quin Tobaku” yaitu ibu Irna mulai mengembangkan toko bahan
                    kuenya
                </p>
            </div>
            ...
            <div class="mt-10">
                <p class="text-xl italic ">
                    Premium, Berkualitas Tinggi, Lezat dan Penuh Makna
                </p>
                <p class="text-xl italic  mt-4">
                    Bagikan momen tak terlupakan dengan cinta, kasih sayang serta penuh kehangatan bersama orang
                    terkasih dengan sajian istimewa
                </p>
            </div>
            ...
            <div class="mt-12 items-center justify-center flex">
                <div class="p-7 border-2 border-black">
                    <p class="text-xl">
                        Jam Operasional : 07.00 - 20.30<br>
                        Alamat : Jl. Tambak Rejo No.33, Tambak Kidul, Tambakrejo, Kec. Waru, Kabupaten Sidoarjo, Jawa
                        Timur
                        61256<br>
                        No Whatsapp : 08563215844
                    </p>
            ...
            <div class="relative flex items-center justify-center w-full mt-14">
                ...
                <h1
                    class="absolute px-10 text-2xl font-medium text-yellow-600 bg-white dark:text-white dark:bg-gray-900">
                    Lokasi Toko Offline Kami</h1>
            </div>
            <div class="mt-12 items-center justify-center flex">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15827.904763515891!2d112.7776542!3d-7.3565651!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7e55ee1b1d487%3A0xbed6b3211f1ee3e2!2sQUIN%20TOBAKU%20(TOKO%20BAHAN%20KUE)!5e0!3m2!1sen!2sid!4v1717565762989!5m2!1sen!2sid"
                    width="800" height="450" style="border:0;" allowfullscreen="" loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div class="mt-12 justify-center flex">
                <a href="https://maps.app.goo.gl/oPPaA3eXrrfR4NfZ8"
                    class="text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-10 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2 ">
                    ...
                    Cari Lokasi Toko Offline Kami melalui Google Maps
                </a>
            </div>
            ...
            <!-- Ulasan -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-12 mt-28 px-10">
                ...
                <div class="flex flex-col gap-4 bg-white p-4 border-2 shadow-md rounded-md">
                    ...
                    <figure class="max-w-screen-md">
                        ...
                        <blockquote>
                            <p class="text-2xl font-semibold text-gray-900 dark:text-white">"baik, packing aman sampai dengan selamat di tempat tujuan. Pengiriman cepat dan fast respon"</p>
                        </blockquote>
                        <figcaption class="flex items-center mt-6 space-x-3 rtl:space-x-reverse">
                            <img class="w-6 h-6 rounded-full"
                                src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
