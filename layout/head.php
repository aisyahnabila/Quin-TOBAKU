...
<head>
    ...
    <title>Home | Welcome To Quin Tobaku</title>
                    ...
                    <ul
                        ...
                        <li>
                            <a href="index.php" data-page="index"
                                class="nav-link block py-2 px-3 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-yellow-600 md:p-0 md:dark:hover:text-yellow-600 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                                aria-current="page">BERANDA</a>
                        </li>
                        <li>
                            <a href="tentang.php" data-page="tentang"
                                class="nav-link block py-2 px-3 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-yellow-600 md:p-0 md:dark:hover:text-yellow-600 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">TENTANG
                                KAMI</a>
                        </li>
                        <li>
                            <a href="produk.php" data-page="produk"
                                class="nav-link block py-2 px-3 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-yellow-600 md:p-0 md:dark:hover:text-yellow-600 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">PRODUK</a>
                        </li>
                    </ul>
                </div>
            </div>
